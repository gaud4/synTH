<template>
  <div id="Home">
    <div id="Home__crowd-image" :style="crowdImageStyles"></div>

    <div id="Home__logo-container">
      <div id="Home__logo">
        <div id="Home__app-name">
          <span id="Home__name-light">synTH</span>
        </div>
    ...
    <RoomConnectionForm id="Home__room-connection-form" />
...
#Home {
    ...
    @keyframes image-hue-anim {
      ...
      100% {
        filter: hue-rotate(0deg),
          opacity($opacity-amount) brightness($brightness-amount);
      }
    }
  }
  ...
  & #Home__logo-container {
    ...
    background: linear-gradient(
      90deg,
      rgba(0, 0, 0, 0) 0%,
      rgba(0, 0, 0, $final-opacity) $cutoff,
      rgba(0, 0, 0, $final-opacity) 100% - $cutoff,
      rgba(0, 0, 0, 0) 100%
    );
